def run():
    ...
    if TASKS['postprocess']:
        ...
        predict_and_process(path_model_file=path_best_model_separator, path_data=path_data / 'val', device=DEVICE, replace_dirs=True,
                    path_pdfs=path_pdfs, path_words=path_words, padding=PADDING, out_data=False, out_images=False, out_labels_rows=True, ground_truth=True, subtract_one_from_pagenumber=True)
